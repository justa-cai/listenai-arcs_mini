...
#define LISAUI_APP_LS_LLM_DIALOG_UI_RES_PERFIX_PATH(path) "app/llm/lisaui/refactor/user/widgets/" path
#else
// #define LISAUI_APP_LS_LLM_DIALOG_UI_RES_PERFIX_PATH(path) "src/ui/lisaui/widgets/" path
#define LISAUI_APP_LS_LLM_DIALOG_UI_RES_PERFIX_PATH(path) "source/view/lisaui/widgets/" path
// app/llm/lisaui/widgets/assets/gif/ani_talk.gif
#endif

// 先定义路径，再传递给宏
#if CONFIG_LVGL_ENV_SIMULATOR
#define ANI_TALK_PATH "app/llm/lisaui/refactor/user/widgets/assets/gif/ani_talk-10fps.gif"
#else
#define ANI_TALK_PATH "../widgets/assets/gif/ani_talk-10fps.gif"
#endif

UI_RES_IMG_NAME(ani_talk, ANI_TALK_PATH)
