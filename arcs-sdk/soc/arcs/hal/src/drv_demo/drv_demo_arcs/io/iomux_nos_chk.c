...
extern void nos_delay_ms(uint32_t nms);
...
// GPIOA_15 - GPIOA_20 for default function to flash IO
...
static function test_function_array[] = {
    ...
    GPIOA_X_NEGATIVE_EDGE_INTERRUPT,
...
/*Callback*/
static void GPIOA_EventCallback(uint32_t event, void* workspace){
//  CLOGD("Trigger GPIOA interrupt: %ud", event);
    GPIOA_Event |= event;
    trigger_times++;
}
...
static void GPIOA_PIN3_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN3);
...
static void GPIOA_PIN4_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN4);
...
static void GPIOA_PIN5_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN5);
...
static void GPIOA_PIN6_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN6);
...
static void GPIOA_PIN7_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN7);
...
static void GPIOA_PIN8_OUT(void){
    IOMuxManager_PinConfigure(CSK_IOMUX_PAD_A, 8, CSK_IOMUX_FUNC_DEFAULT);

    GPIO_Initialize(GPIOA_Handler, NULL, NULL);

    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN8);
...
static void GPIOA_PIN9_OUT(void){
    IOMuxManager_PinConfigure(CSK_IOMUX_PAD_A, 9, CSK_IOMUX_FUNC_DEFAULT);

    GPIO_Initialize(GPIOA_Handler, NULL, NULL);

    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN9);
...
static void GPIOA_PIN10_OUT(void){
    IOMuxManager_PinConfigure(CSK_IOMUX_PAD_A, 10, CSK_IOMUX_FUNC_ALTER1);
...
static void GPIOA_PIN12_OUT(void){
    IOMuxManager_PinConfigure(CSK_IOMUX_PAD_A, 12, CSK_IOMUX_FUNC_ALTER1);

    GPIO_Initialize(GPIOA_Handler, NULL, NULL);

    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN12);
...
static void GPIOA_PIN13_OUT(void){
    IOMuxManager_PinConfigure(CSK_IOMUX_PAD_A, 13, CSK_IOMUX_FUNC_ALTER1);

    GPIO_Initialize(GPIOA_Handler, NULL, NULL);

    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN13);
...
static void GPIOA_PIN14_OUT(void){
    IOMuxManager_PinConfigure(CSK_IOMUX_PAD_A, 14, CSK_IOMUX_FUNC_ALTER1);

    GPIO_Initialize(GPIOA_Handler, NULL, NULL);

    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN14);
...
static void GPIOA_PIN15_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN15);
...
static void GPIOA_PIN16_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN16);
...
static void GPIOA_PIN17_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN17);
...
static void GPIOA_PIN18_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN18);
...
static void GPIOA_PIN19_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN19);
...
static void GPIOA_PIN20_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN20);
...
static void GPIOA_PIN21_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN21);
...
static void GPIOA_PIN22_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN22);
...
static void GPIOA_PIN23_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN23);
...
static void GPIOA_PIN24_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN24);
...
static void GPIOA_PIN25_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN25);
...
static void GPIOA_PIN26_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN26);
...
static void GPIOA_PIN27_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN27);
...
static void GPIOA_PIN28_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN28);
...
static void GPIOA_PIN29_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN29);
...
static void GPIOA_PIN30_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN30);
...
static void GPIOA_PIN31_OUT(void){
    ...
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN31);
...
static void GPIOB_PIN0_OUT(void){
    ...
    GPIO_Control(GPIOB_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN0);
...
static void GPIOB_PIN1_OUT(void){
    ...
    GPIO_Control(GPIOB_Handler, CSK_GPIO_MODE_PULL_NONE | \
                                CSK_GPIO_DEBOUNCE_DISABLE, CSK_GPIO_PIN1);
...
static void GPIOB_PIN2_OUT(void){
    IOMuxManager_PinConfigure(CSK_IOMUX_PAD_B, 20, CSK_IOMUX_FUNC_DEFAULT);
...
#define GPIOA_INT_SOUR_PIN          (11)
#define GPIOA_INT_DEST_PIN          (12)
...
static void GPIOA_X_HIGH_LEVEL_INTERRUPT(void){
    CLOGD("[GPIOA INT] HIGH LEVEL MODE");
    ...
    GPIO_Initialize(GPIOA_Handler, GPIOA_EventCallback, NULL);
    GPIO_Control(GPIOA_Handler, CSK_GPIO_MODE_PULL_NONE | \
    ...
    GPIO_PinWrite(GPIOA_Handler, (1UL << GPIOA_INT_SOUR_PIN), 1);
    while(!(GPIOA_Event & (1UL << GPIOA_INT_SOUR_PIN)));
    GPIOA_Event = 0;
    GPIO_PinWrite(GPIOA_Handler, (1UL << GPIOA_INT_SOUR_PIN), 0);
...
static void GPIOA_X_LOW_LEVEL_INTERRUPT(void){
    CLOGD("[GPIOA INT] LOW LEVEL MODE");
...
static void GPIOA_X_NEGATIVE_EDGE_INTERRUPT(void){
    CLOGD("[GPIOA INT] NEGATIVE EDGE MODE");
...
static void GPIOA_X_POSITIVE_EDGE_INTERRUPT(void){
    CLOGD("[GPIOA INT] POSITIVE EDGE MODE");
...
static void GPIOA_X_DUAL_EDGE_INTERRUPT(void){
    CLOGD("[GPIOA INT] DUAL EDGE MODE");
...
int main(){
    uint32_t times;
    logInit(0, 115200);
    CLOGD("[TEST] GPIO & IOMUX VALIDATION");
