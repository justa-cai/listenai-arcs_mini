...
/* Platform options */
#define MBEDTLS_PLATFORM_STD_MEM_HDR   "mbedtls_platform_ls.h" /**< Header to include if MBEDTLS_PLATFORM_NO_STD_FUNCTIONS is defined. Don't define if no header is needed. */
...
#define MBEDTLS_PLATFORM_CALLOC_MACRO   rtos_calloc /**< Default allocator macro to use, can be undefined. See MBEDTLS_PLATFORM_STD_CALLOC for requirements. */
#define MBEDTLS_PLATFORM_FREE_MACRO     rtos_free /**< Default free macro to use, can be undefined. See MBEDTLS_PLATFORM_STD_FREE for requirements. */
