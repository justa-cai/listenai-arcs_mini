 ...
 * @file net_iperf.h
 *
 * @brief Definitions of the Iperf task.
 *
 * Copyright (C) ListenAI  2024-2025
 *
 ****************************************************************************************
 */
#ifndef _NET_IPERF_H_
#define _NET_IPERF_H_
...
#define NET_IPERF_MAX_STREAMS 4

/// UDP Rate
#define NET_IPERF_DEFAULT_UDPRATE     1024 * 1024     // 1 Mbit/sec (-u)
/// UDP buffer length
#define NET_IPERF_DEFAULT_UDPBUFLEN   1470            // read/write 1470 bytes (-u)
/// Invalid socket id
#define NET_IPERF_INVALID_SOCKET      -1
/// Time to travel
#define NET_IPERF_TTL                 128
/// Number of IPERF send buffers (credits)
#define NET_IPERF_SEND_BUF_CNT        MAC_TXQ_DEPTH
#define IPERF_REPORT_TIMER
/// Type of traffic generation
enum test_mode
{
    /// Unidirectional test
    NET_IPERF_TEST_NORMAL = 0,
    /// Bidirectional test simultaneously
    NET_IPERF_TEST_DUALTEST,
    /// Unkwnow test mode
    NET_IPERF_TEST_UNKNOWN,
};
...
#define UPD_CLIENT_EXTRA_HDR_LEN 24
struct iperf_UDP_datagram
{
    ...
    uint32_t usec;
    /// extra header
    uint8_t array[UPD_CLIENT_EXTRA_HDR_LEN];
};
...
#define iperf_current_time(a) \
    rtos_get_sys_time(SINCE_BOOT, &(a)->sec, &(a)->usec);
...
#define iperf_timerusec(a) (((uint64_t)(a)->sec * 1000000) + (a)->usec)
...
/// Iperf streams
extern struct net_iperf_stream i_streams[NET_IPERF_MAX_STREAMS];
 ...
 *
 * @return FHOST_CLI_SUCCESS if successful, FHOST_CLI_ERROR otherwise
 ****************************************************************************************
 **/
...
void net_iperf_report_timer_start(struct net_iperf_stream *iperf_stream);
void net_iperf_report_timer_stop(struct net_iperf_stream *iperf_stream);
