 ...
 * @file net_tg_al.h
 *
 * @brief Declaration of the networking stack abstraction layer used for traffic
 * generator.
 *
 * The functions declared here shall be implemented in the networking stack using its
 * internal API.
 *
...
/**
 ****************************************************************************************
 * @brief Send UDP packet to a destination IP address without allocating memory for
 * buffer, used for @ref FHOST_PROF_FILE_TX.
 *
