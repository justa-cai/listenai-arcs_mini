 ...
 * All rights reserved.                                                    *
 ***************************************************************************/
#ifndef __LUNA_MATRIX_MATH_H_SIM__
#define __LUNA_MATRIX_MATH_H_SIM__
...
int32_t LUNA_API_SIM(luna_mat_trans_i8o8)(const int8_t *src1, int8_t *dst, uint32_t row, uint32_t col);
int32_t LUNA_API_SIM(luna_mat_trans_i32o32)(const int32_t *src1, int32_t *dst, uint32_t row, uint32_t col);
...
#endif // __LUNA_MATRIX_MATH_H_SIM__
