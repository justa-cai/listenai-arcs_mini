...
FRISO_API int gbk_cn_string(char *str)
{
    ...
    return (((c1 >= 0xb0 && c1 <= 0xf7) && (c2 >= 0xa1 && c2 <= 0xfe))
            ...
            || ((c1 >= 0x81 && c1 <= 0xa0) && ((c2 >= 0x40 && c2 <= 0x7e) || (c2 >= 0x80 && c2 <= 0xfe)))
            // GBK/4: extend chinese words.
            || ((c1 >= 0xaa && c1 <= 0xfe) && ((c2 >= 0x40 && c2 <= 0xfe) || (c2 >= 0x80 && c2 <= 0xa0))));
}
...
FRISO_API int gbk_fullwidth_en_char(char *str)
{
    int c1 = (uchar_t)str[0];
    int c2 = (uchar_t)str[1];
    return ((c1 == 0xA3) && ((c2 >= 0xB0 && c2 <= 0xB9)       // arabic numbers.
...
FRISO_API int gbk_en_letter(char *str)
{
    ...
    {
        return ((c1 == 0xa3) && ((c2 >= 0xc1 && c2 <= 0xda)       // lowercase
...
FRISO_API int gbk_letter_number(char *str)
{
    int c1 = (uchar_t)str[0];
    int c2 = (uchar_t)str[1];
    return ((c1 == 0xa2) && ((c2 >= 0xa1 && c2 <= 0xb0)       // lowercase
...
{
    int u = (uchar_t)c;
    return ((u > 32 && u < 48) || (u > 57 && u < 65) || (u > 90 && u < 97) || (u > 122 && u < 127));
}
...
FRISO_API int gbk_cn_punctuation(char *str)
{
    ...
    return ((c1 == 0xa3 && ((c2 >= 0xa1 && c2 <= 0xaf) || (c2 >= 0xba && c2 <= 0xc0) || (c2 >= 0xdb && c2 <= 0xe0) || (c2 >= 0xfb && c2 <= 0xfe)))
            // chinese punctuation.
            || (c1 == 0xa1 && ((c2 >= 0xa1 && c2 <= 0xae) || (c2 >= 0xb0 && c2 <= 0xbf)))
