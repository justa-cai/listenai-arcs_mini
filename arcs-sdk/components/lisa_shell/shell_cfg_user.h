 ...
 * @brief 是否在登录后清除命令行
 */
#ifdef CONFIG_LISA_SHELL_CLS_WHEN_LOGIN
 ...
 * @brief 支持shell尾行模式
 */
#ifdef CONFIG_LISA_SHELL_SUPPORT_END_LINE
 ...
 */
#ifdef CONFIG_LISA_SHELL_ENTER_LF
 ...
 */
#ifdef CONFIG_LISA_SHELL_ENTER_CR
 ...
 */
#ifdef CONFIG_LISA_SHELL_ENTER_CRLF
 ...
 */
#ifdef CONFIG_LISA_SHELL_SCAN_BUFFER
#define     SHELL_SCAN_BUFFER          CONFIG_LISA_SHELL_SCAN_BUFFER
#else
