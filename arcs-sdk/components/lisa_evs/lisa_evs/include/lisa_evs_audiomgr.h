#ifndef __LISA_EVS_SDK_AUDIOMGR_H__
#define __LISA_EVS_SDK_AUDIOMGR_H__
...
typedef struct lisa_evs_audiomgr_s {
 ...
 * @param type      通道类型
 */
void lisa_evs_audiomgr_acquire_channel(lisa_evs_audiomgr_t *handle, channel_type_e type);
 ...
 * @param type      通道类型
 */
void lisa_evs_audiomgr_release_channel(lisa_evs_audiomgr_t *handle, channel_type_e type);
