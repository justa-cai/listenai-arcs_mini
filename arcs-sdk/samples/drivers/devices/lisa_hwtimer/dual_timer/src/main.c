...
/**
 * @file main.c
 * @brief LISA DUAL HWTIMER 基础示例 - 周期定时器
 *
 */
...
#define TIMER_FREQ_HZ  16000  /* 16kHz */
#define TIMER_COUNT    TIMER_FREQ_HZ/2  /* 触发间隔: 0.5秒 */
...
{
    LISA_LOGI(LOG_TAG, "=== LISA DUAL HWTIMER basic example ===");
