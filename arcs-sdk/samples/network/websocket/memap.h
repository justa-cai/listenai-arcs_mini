...
#define MEM_AP_FLASH_SIZE  __KB__(2048)

#define MEM_CP_FLASH_BASE  (0x30000000 + __MB__(10))
#define MEM_CP_FLASH_SIZE  __MB__(3)
...
#define MEM_CP_WIFI_RAM_SIZE  (__KB__(25) - 128)        //暂留128(0x80)字节给WiFi硬件

#define MEM_CP_SRAM_BASE  ((MEM_CP_WIFI_RAM_BASE) + (MEM_CP_WIFI_RAM_SIZE))
#define MEM_CP_SRAM_SIZE  (__KB__(96))

#define MEM_AP_WIFI_RAM_BASE  ((MEM_CP_SRAM_BASE) + (MEM_CP_SRAM_SIZE))
#define MEM_AP_WIFI_RAM_SIZE  (__KB__(39))

#define MEM_AP_SRAM_BASE  ((MEM_AP_WIFI_RAM_BASE) + (MEM_AP_WIFI_RAM_SIZE))
#define MEM_AP_SRAM_SIZE  (__KB__(117))

#define MEM_LUNA_BASE  ((MEM_AP_SRAM_BASE) + (MEM_AP_SRAM_SIZE))
#define MEM_LUNA_SIZE  (__KB__(35))

#define MEM_IPC_BASE  (MEM_LUNA_BASE + MEM_LUNA_SIZE)
...
/* wifi sram 必须要在 0x20040000 ~ 0x20040000 + 64(KB)之间 */
#if (MEM_LUNA_BASE < 0x20040000) || ((MEM_LUNA_BASE + MEM_LUNA_SIZE) > (0x20040000 + __KB__(64)))
