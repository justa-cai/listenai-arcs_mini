 ...
 */
  ...
  */
  ...
  /* Heap support */
 #if defined(CONFIG_MBEDTLS_ENABLE_HEAP) && (CONFIG_MBEDTLS_HEAP_SIZE > 0)
 ...
 #define MBEDTLS_PLATFORM_STD_MEM_HDR   "ls_mbedtls_platform.h" 
 ...
 #define MBEDTLS_PLATFORM_TIME_MACRO            ls_time
 #else
 ...
 #include "ls_mem.h"
 #define MBEDTLS_PLATFORM_STD_CALLOC		ls_mbedtls_mem_calloc
 #define MBEDTLS_PLATFORM_STD_FREE		ls_mbedtls_mem_free
 #endif
 ...
 /* The following units have ls hardware support,
 ...
 #if defined(CONFIG_MBEDTLS_HARDWARE_AES_CCM)
 ...
 #if defined(CONFIG_MBEDTLS_HARDWARE_AES_GCM)
 #define MBEDTLS_GCM_ALT
 #else
 #undef MBEDTLS_GCM_ALT
 #endif
 
 #if defined(CONFIG_MBEDTLS_HARDWARE_AES_CMAC)
 ...
 */
 ...
 #if defined(CONFIG_MBEDTLS_HARDWARE_SHA1)
 #define MBEDTLS_SHA1_ALT
 #else
 #undef MBEDTLS_SHA1_ALT
 #endif
 
 #if defined(CONFIG_MBEDTLS_HARDWARE_SHA256)
 #define MBEDTLS_SHA256_ALT
 #else
 #undef MBEDTLS_SHA256_ALT
 #endif
 
 #if defined(CONFIG_MBEDTLS_HARDWARE_SHA512)
 ...
 /* MBEDTLS_MDx_ALT to enable ROM MD support
    with software fallback.
 */
 #ifdef CONFIG_MBEDTLS_HARDWARE_ROM_MD5
  ...
  */
 #define MBEDTLS_AES_ROM_TABLES  //need test
  ...
  */
 #define MBEDTLS_CIPHER_MODE_CBC  //need test
  ...
  */
 #define MBEDTLS_CIPHER_MODE_CFB   //need test
  ...
  */
 #define MBEDTLS_CIPHER_MODE_CTR   //need test
  ...
  */
 #define MBEDTLS_CIPHER_MODE_OFB   //need test
  ...
  */
 #define MBEDTLS_CIPHER_MODE_XTS   //need test
 ...
 #define MBEDTLS_ECP_RESTARTABLE  //no
 #endif
 ...
 #define MBEDTLS_ECDH_LEGACY_CONTEXT    //no
 #endif
 ...
 #define MBEDTLS_ECP_NIST_OPTIM   //y
 #else
 ...
 #define MBEDTLS_ECDSA_DETERMINISTIC   //y
 #else
 ...
 #define MBEDTLS_KEY_EXCHANGE_PSK_ENABLED   //no
 #else
 ...
 #else
 #undef MBEDTLS_KEY_EXCHANGE_DHE_PSK_ENABLED   //y
 #endif
 ...
 #define MBEDTLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED  //y
 #else
 ...
 #define MBEDTLS_KEY_EXCHANGE_RSA_PSK_ENABLED  //y
 #else
 ...
 #define MBEDTLS_KEY_EXCHANGE_RSA_ENABLED  //y
 #else
 ...
 #define MBEDTLS_KEY_EXCHANGE_DHE_RSA_ENABLED  //y
 #else
 ...
 #define MBEDTLS_KEY_EXCHANGE_ECDHE_RSA_ENABLED  //y
 #else
 ...
 #define MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED //y
 #else
 ...
 #define MBEDTLS_KEY_EXCHANGE_ECDH_ECDSA_ENABLED  //y
 #else
 ...
 #define MBEDTLS_KEY_EXCHANGE_ECDH_RSA_ENABLED  //y
 #else
 ...
 #define MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED //no
 #else
  ...
  */
 // #define MBEDTLS_FS_IO   // not use filesystem
 ...
 #define MBEDTLS_SSL_DTLS_CONNECTION_ID   //no
 #else
 ...
 #define MBEDTLS_SSL_CONTEXT_SERIALIZATION  //no
 #else
 ...
 #define MBEDTLS_SSL_KEEP_PEER_CERTIFICATE  //no
 #else
 ...
 #define MBEDTLS_SSL_PROTO_TLS1_1// yes
 #else
 ...
 #define MBEDTLS_SSL_PROTO_TLS1_2 //yes
 #else
 ...
 #define MBEDTLS_SSL_PROTO_DTLS  //no
 #else
  ...
  */
 #ifdef CONFIG_MBEDTLS_SSL_PROTO_DTLS
 #define MBEDTLS_SSL_DTLS_HELLO_VERIFY  //no
 #else
  ...
  */
 #ifdef CONFIG_MBEDTLS_SSL_PROTO_DTLS
 #define MBEDTLS_SSL_DTLS_SRTP   //no
 #else
  ...
  */
 #ifdef CONFIG_MBEDTLS_SSL_PROTO_DTLS
 #define MBEDTLS_SSL_DTLS_CLIENT_PORT_REUSE   //no
 #else
  ...
  */
 #ifdef CONFIG_MBEDTLS_SSL_PROTO_DTLS
 #define MBEDTLS_SSL_DTLS_BADMAC_LIMIT   //no
 #else
 ...
 #define MBEDTLS_X509_CHECK_KEY_USAGE  //no
 #else
 ...
 #define MBEDTLS_CHACHAPOLY_C  //no
 #else
  ...
  *
  * Requires: MBEDTLS_ECP_C yes
  */
 #ifdef CONFIG_MBEDTLS_ECDH_C
 #define MBEDTLS_ECDH_C  //y
 #else
 ...
 #define MBEDTLS_SSL_TICKET_C  //no
 #else
 ...
 #define MBEDTLS_X509_CRL_PARSE_C  //y
 #else
 ...
 #define MBEDTLS_X509_CSR_PARSE_C  //y
 #else
 ...
 #define MBEDTLS_X509_ALLOW_UNSUPPORTED_CRITICAL_EXTENSION //no
 #else
 ...
 #define MBEDTLS_X509_TRUSTED_CERTIFICATE_CALLBACK //no
 #else
  ...
  *
  */
 #ifdef CONFIG_MBEDTLS_SSL_DTLS_CONNECTION_ID  //no
  ...
  */
 #ifdef CONFIG_MBEDTLS_THREADING_C  //no
