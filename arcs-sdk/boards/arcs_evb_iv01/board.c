...
static void lisa_sdioh_iomux_config()
{
    IOMuxManager_PinConfigure(LISA_SDIOH_CLK_PORT,  LISA_SDIOH_CLK_PIN,  LISA_SDIOH_CLK_FUNC);
    IOMuxManager_PinConfigure(LISA_SDIOH_CMD_PORT,  LISA_SDIOH_CMD_PIN,  LISA_SDIOH_CMD_FUNC);
    IOMuxManager_PinConfigure(LISA_SDIOH_DAT0_PORT, LISA_SDIOH_DAT0_PIN, LISA_SDIOH_DAT0_FUNC);
    IOMuxManager_PinConfigure(LISA_SDIOH_DAT1_PORT, LISA_SDIOH_DAT1_PIN, LISA_SDIOH_DAT1_FUNC);
    IOMuxManager_PinConfigure(LISA_SDIOH_DAT2_PORT, LISA_SDIOH_DAT2_PIN, LISA_SDIOH_DAT2_FUNC);
    IOMuxManager_PinConfigure(LISA_SDIOH_DAT3_PORT, LISA_SDIOH_DAT3_PIN, LISA_SDIOH_DAT3_FUNC);
}

static void lisa_aon_iomux_config()
{
    AON_IOMuxManager_PinConfigure(LISA_KEY_ADC_AON_PORT, LISA_KEY_ADC_AON_PIN, LISA_KEY_ADC_AON_FUNC);
}

static void lisa_misc_iomux_config(void)
{
    IOMuxManager_PinConfigure(LISA_PA_MUTE_PORT,   LISA_PA_MUTE_PIN,   LISA_PA_MUTE_FUNC);
    IOMuxManager_PinConfigure(LISA_LED_RED_PORT,   LISA_LED_RED_PIN,   LISA_LED_RED_FUNC);
...
#ifdef CONFIG_LISA_TOUCH
static void lisa_touch_iomux_config()
{
...
static void lisa_camera_iomux_config()
{
    ...
    IOMuxManager_PinConfigure(LISA_CAMERA_PWDN_PORT, LISA_CAMERA_PWDN_PIN, LISA_CAMERA_PWDN_FUNC);
