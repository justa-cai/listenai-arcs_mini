...
#define OTA_ZONE_BOOT_SIZE      0x8000
...
// partition 2, execute zone 2, wifi image, 512KB #0xB0000
#define OTA_ZONE_EXE2_ADDRESS   (OTA_ZONE_EXE1_ADDRESS + OTA_ZONE_EXE1_SIZE)
#define OTA_ZONE_EXE2_SIZE      0x10000

// partition 3, execute zone 3, bt image, 704KB #0xB0000
#define OTA_ZONE_EXE3_ADDRESS   (OTA_ZONE_EXE2_ADDRESS + OTA_ZONE_EXE2_SIZE)
#define OTA_ZONE_EXE3_SIZE      0x10000

// partition OTA data, 1.4MB #0x160000
#define OTA_ZONE_OTA_ADDRESS   (OTA_ZONE_EXE3_ADDRESS + OTA_ZONE_EXE3_SIZE)
#define OTA_ZONE_OTA_SIZE      0x10000
