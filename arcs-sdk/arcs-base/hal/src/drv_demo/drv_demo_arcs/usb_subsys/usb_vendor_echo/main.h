...
#ifndef SRC_USB_SUBSYS_DEMO_USB_VENDOR_ECHO_H_
#define SRC_USB_SUBSYS_DEMO_USB_VENDOR_ECHO_H_
...
#define EPNUM_VEN0_IN_EXT	0x02 // (EPNUM_VEN0_IN + EPNUM_VEND_ADDR_STEP)
#define EPNUM_VEN0_OUT_EXT	0x02 // (EPNUM_VEN0_OUT + EPNUM_VEND_ADDR_STEP)
#define EPNUM_VEN0_LAST_IN	EPNUM_VEN0_IN_EXT
#define EPNUM_VEN0_LAST_OUT	EPNUM_VEN0_OUT_EXT

#define EPNUM_VEN1_IN		0x03 // (EPNUM_VEN0_LAST_IN + EPNUM_VEND_ADDR_STEP)
#define EPNUM_VEN1_OUT		0x03 // (EPNUM_VEN0_LAST_OUT + EPNUM_VEND_ADDR_STEP)
#define EPNUM_VEN1_LAST_IN	EPNUM_VEN1_IN
#define EPNUM_VEN1_LAST_OUT	EPNUM_VEN1_OUT

#define EPNUM_VEN2_IN		0x04 // (EPNUM_VEN1_LAST_IN + EPNUM_VEND_ADDR_STEP)
#define EPNUM_VEN2_OUT		0x04 // (EPNUM_VEN1_LAST_OUT + EPNUM_VEND_ADDR_STEP)
...
#define EP_MPS_VEN0_IN          (TUD_OPT_HIGH_SPEED ? 512 : 64)
#define EP_MPS_VEN0_OUT         (TUD_OPT_HIGH_SPEED ? 512 : 64)
#define EP_MPS_VEN0_IN_EXT      64 // 4
#define EP_MPS_VEN0_OUT_EXT     64 // 4
#define EP_MPS_VEN1_IN      16
#define EP_MPS_VEN1_OUT     16
#define EP_MPS_VEN2_IN      8
#define EP_MPS_VEN2_OUT     8

#endif /* SRC_USB_SUBSYS_DEMO_USB_VENDOR_ECHO_H_ */
