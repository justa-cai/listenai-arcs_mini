...
#ifndef SRC_USB_SUBSYS_DEMO_USB_CDC_HID_H_
#define SRC_USB_SUBSYS_DEMO_USB_CDC_HID_H_
...
#define CDC0_HAS_NOTIF_EP   0 // 1
#define CDC1_HAS_NOTIF_EP   0 // 1
...
#define EPNUM_CDC_1_NOTIF       0x03 //0x84
#endif

#define EPNUM_CDC_1_DATA        0x02
...
//NOTE: The highest bit: bit[7] = 1, indicate IN direction (device->host); bit[7] = 0, indicate OUT direction (host->device)
#define EPADDR_HID_IN   0x82 // IN, EP1
...
#define USE_VAR_INPUT   1 // 1: Variable, 0: Array
#define HID_REPORT_LEN  1 // 4 //CFG_TUD_HID_EP_BUFSIZE//8 //2 // excluding Report ID if any
