...
int main()
{
	...
	//Set Master Mode
	IP_AUDIO_APC->REG_APC_I2S0_CFG0.bit.I2S0_MASTER_MODE = 0x0; //0:slave,1:master
	IP_AUDIO_APC->REG_APC_I2S0_CFG1.bit.I2S0_BCK_DIV = 0x4;
	IP_AUDIO_APC->REG_APC_I2S0_CFG1.bit.I2S0_BCK_DIV_LD = 0;
	IP_AUDIO_APC->REG_APC_I2S0_CFG0.bit.I2S0_BCK_LRCK = 0x12;
	IP_AUDIO_APC->REG_APC_CFG.bit.DAC_DATA_SRC = 3;//iis0_dac0 loop,only left channel
