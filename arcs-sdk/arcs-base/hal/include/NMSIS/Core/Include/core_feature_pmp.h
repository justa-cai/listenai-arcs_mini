 ...
 * \param [in]    entry_idx    PMP region index(0-7)
 ...
 * \param [in]    entry_idx      PMPx region index(0-7)
 ...
 * \param [in]    csr_idx    PMP region CSR index(0-7)
 ...
 * \param [in]    entry_idx    PMP entry index(0-7)
