...
// Core 1 - CMNCFG 0x43100000
#define ICACHE_MISS_COUNT_REG_ADDR           (0x43100000 + 0xB4)
#define ICACHE_HIT_MISS_TOTAL_COUNT_REG_ADDR (0x43100000 + 0xB8)
#define DCACHE_MISS_COUNT_REG_ADDR           (0x43100000 + 0xBC)
#define DCACHE_HIT_MISS_TOTAL_COUNT_REG_ADDR (0x43100000 + 0xC0)

#define CACHE_COUNTER_CLEAR_REG_ADDR        (0x43100000 + 0xB0)

#else

// Core 0 - APCFG 0x43100000
#define ICACHE_MISS_COUNT_REG_ADDR           (0x43100000 + 0xC8)
#define ICACHE_HIT_MISS_TOTAL_COUNT_REG_ADDR (0x43100000 + 0xCC)
#define DCACHE_MISS_COUNT_REG_ADDR           (0x43100000 + 0xD0)
#define DCACHE_HIT_MISS_TOTAL_COUNT_REG_ADDR (0x43100000 + 0xD4)

#define CACHE_COUNTER_CLEAR_REG_ADDR        (0x43100000 + 0xC4)

#endif

#define ICACHE_COUNTER_CLEAR_REG_VAL         (0x00000001)
#define DCACHE_COUNTER_CLEAR_REG_VAL         (0x00000002)

/**
 * \brief  Fetch the ICache Miss Count
 * \details
 * This function fetches the Icache miss count.
 * \return  The Icache miss count.
 */
__STATIC_FORCEINLINE uint32_t FetchICacheMissCount(void)
{
    return *((volatile uint32_t *)ICACHE_MISS_COUNT_REG_ADDR);
}

/**
 * \brief  Fetch the ICache Hit and Miss Total Count
 * \details
 * This function fetches the Icache hit and miss total count.
 * \return  The Icache hit and miss total count.
 */
__STATIC_FORCEINLINE uint32_t FetchICacheHitMissTotalCount(void)
{
    return *((volatile uint32_t *)ICACHE_HIT_MISS_TOTAL_COUNT_REG_ADDR);
}


/**
 * \brief  Fetch the DCache Miss Count
 * \details
 * This function fetches the Dcache miss count.
 * \return  The Dcache miss count.
 */
__STATIC_FORCEINLINE uint32_t FetchDCacheMissCount(void)
{
    return *((volatile uint32_t *)DCACHE_MISS_COUNT_REG_ADDR);
}

/**
 * \brief  Fetch the DCache Hit and Miss Total Count
 * \details
 * This function fetches the Dcache hit and miss total count.
 * \return  The Dcache hit and miss total count.
 */
__STATIC_FORCEINLINE uint32_t FetchDCacheHitMissTotalCount(void)
{
    return *((volatile uint32_t *)DCACHE_HIT_MISS_TOTAL_COUNT_REG_ADDR);
}

/**
 * \brief  Clear the ICache Counters
 * \details
 * This function clears the Icache counters.
 */
__STATIC_FORCEINLINE void ClearICacheCounters(void)
{
    *((volatile uint32_t *)CACHE_COUNTER_CLEAR_REG_ADDR) = ICACHE_COUNTER_CLEAR_REG_VAL;
}

/**
 * \brief  Clear the DCache Counters
 * \details
 * This function clears the Dcache counters.
 */

__STATIC_FORCEINLINE void ClearDCacheCounters(void)
{
    *((volatile uint32_t *)CACHE_COUNTER_CLEAR_REG_ADDR) = DCACHE_COUNTER_CLEAR_REG_VAL;
}
...
__STATIC_FORCEINLINE int32_t GetICacheInfo(CacheInfo_Type *info)
{
    ...
    CSR_MICFGINFO_Type csr_ccfg = { .d = __RV_CSR_READ(CSR_MICFG_INFO) };
...
__STATIC_FORCEINLINE int32_t GetDCacheInfo(CacheInfo_Type *info)
{
    ...
    CSR_MDCFGINFO_Type csr_ccfg = { .d = __RV_CSR_READ(CSR_MDCFG_INFO)};
    info->setperway = (1 << csr_ccfg.b.set) << 3;
    info->ways = (1 + csr_ccfg.b.way);
    if (csr_ccfg.b.lsize == 0) {
        info->linesize = 0;
