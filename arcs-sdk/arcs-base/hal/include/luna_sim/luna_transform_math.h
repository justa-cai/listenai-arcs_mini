...
#ifndef __LUNA_TRANSFORM_MATH_H_SIM__
#define __LUNA_TRANSFORM_MATH_H_SIM__
...
int32_t LUNA_API_SIM(luna_cifft_i32o32)(const int32_t *src, int32_t *dst, int32_t *fft_shift, e_fft_points points);
int32_t LUNA_API_SIM(luna_rfft_i32o32)(const int32_t *src, int32_t *dst, int32_t *fft_rshift, e_fft_points points);
int32_t LUNA_API_SIM(luna_rifft_i32o32)(const int32_t *src, int32_t *dst, int32_t *fft_shift, e_fft_points points);

#endif /* __LUNA_TRANSFORM_MATH_H_SIM__ */
