 ...
 */
curl_malloc_callback Curl_cmalloc = (curl_malloc_callback)curl_mem_malloc;
curl_free_callback Curl_cfree = (curl_free_callback)curl_mem_free;
curl_realloc_callback Curl_crealloc = (curl_realloc_callback)curl_mem_realloc;
curl_strdup_callback Curl_cstrdup = (curl_strdup_callback)system_strdup;
curl_calloc_callback Curl_ccalloc = (curl_calloc_callback)curl_mem_calloc;
...
static CURLcode global_init(long flags, bool memoryfuncs)
{
  ...
  if(memoryfuncs) {
    ...
    Curl_cmalloc = (curl_malloc_callback)curl_mem_malloc;
    Curl_cfree = (curl_free_callback)curl_mem_free;
    Curl_crealloc = (curl_realloc_callback)curl_mem_realloc;
    Curl_cstrdup = (curl_strdup_callback)system_strdup;
    Curl_ccalloc = (curl_calloc_callback)curl_mem_calloc;
#if defined(_WIN32) && defined(UNICODE)
