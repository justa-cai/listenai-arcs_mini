...
// #define <sys/socket.h>   "lwip/sockets.h"
#define USE_LWIPSOCK             1   // 使用 lwIP


// ----------------------------
// 基本协议禁用
// ----------------------------
#define CURL_DISABLE_FTP          1   // 禁用 FTP
#define CURL_DISABLE_TFTP         1   // 禁用 TFTP
#define CURL_DISABLE_FILE         1   // 禁用文件协议（file://）
#define CURL_DISABLE_LDAP         1   // 禁用 LDAP
#define CURL_DISABLE_TELNET       1   // 禁用 Telnet
#define CURL_DISABLE_DICT         1   // 禁用 DICT
#define CURL_DISABLE_RTSP         1   // 禁用 RTSP
#define CURL_DISABLE_POP3         1   // 禁用 POP3
#define CURL_DISABLE_IMAP         1   // 禁用 IMAP
#define CURL_DISABLE_SMTP         1   // 禁用 SMTP
#define CURL_DISABLE_GOPHER       1   // 禁用 Gopher
#define CURL_DISABLE_MQTT         1   // 禁用 MQTT
...
#define CURL_DISABLE_VERBOSE_STRINGS 0 // 保留错误描述（可选)


#define CURL_DISABLE_ALTSVC    1       // 禁用 HTTP Alt-Svc（替代服务）
#define CURL_DISABLE_HSTS      1         // 禁用 HTTP Strict Transport Security
#define CURL_DISABLE_COOKIES   1      // 禁用 Cookie 支持（如果不需要会话）
#define CURL_DISABLE_HTTP_AUTH 1    // 禁用所有 HTTP 认证（Basic/Digest/NTLM）
// 如果不需要认证，可以单独关闭：
// #define CURL_DISABLE_BASIC_AUTH 1
// #define CURL_DISABLE_BEARER_AUTH 1
// #define CURL_DISABLE_DIGEST_AUTH 1
// #define CURL_DISABLE_NTLM 1
#define CURL_DISABLE_AWS 1          // 禁用 AWS S3 签名（如果不用）
#define CURL_DISABLE_DOH 1          // 禁用 DNS-over-HTTPS（DoH）
#define CURL_DISABLE_FORM_API 1     // 禁用 HTTP 表单上传（如 multipart/form-data）
#define CURL_DISABLE_HEADERS_API 1  // 禁用自定义 HTTP 头操作（如果不需要）
#define CURL_DISABLE_MIME 1         // 禁用 MIME 支持
#define CURL_DISABLE_SOCKETPAIR 1    // 禁用 socketpair（lwIP 可能不需要）
...
// 网络栈适配（确保 HTTP 支持）
// ----------------------------
#define USE_LWIPSOCK              1   // 使用 lwIP 的 Socket
#define USE_MBEDTLS               1   // 启用 mbedTLS（如需 HTTPS）
#define HAVE_GETADDRINFO          1   // 确保 DNS 解析可用
...
// #define CURL_DISABLE_HTTP        0   // 确保 HTTP 协议启用（必须）
...
/* cpu-machine-OS */
#define OS "riscv64-unknown-freertos-ABI"
