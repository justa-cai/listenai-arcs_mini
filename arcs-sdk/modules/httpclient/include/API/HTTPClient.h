...
typedef PostData (*HTTP_CLIENT_GET_POST_DATA)();

typedef struct HTTP_CLIENT_CALLBACK_FUNC {
        void *ClientParams;
	HTTP_CLIENT_GET_HEADER HttpcGetHeader;
	HTTP_CLIENT_GET_POST_DATA HttpcGetPostData;
} HTTP_CLIENT_CALLBACK_FUNC;
...
UINT32                  HTTPClientSendRequest         (HTTP_SESSION_HANDLE pSession, CHAR *pUrl, VOID *pData, UINT32 nDataLength, BOOL TotalLength, UINT32 nTimeout, UINT32 nClientPort, HTTP_CLIENT_GET_HEADER GetHeader, HTTP_CLIENT_GET_POST_DATA GetPostData);
