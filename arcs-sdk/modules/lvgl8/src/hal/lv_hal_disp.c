...
#elif LV_USE_GPU_CSK_DMA2D
    driver->draw_ctx_init = lv_draw_csk_dma2d_ctx_init;
    driver->draw_ctx_deinit = lv_draw_csk_dma2d_ctx_init;
    driver->draw_ctx_size = sizeof(lv_draw_csk_dma2d_ctx_t);
