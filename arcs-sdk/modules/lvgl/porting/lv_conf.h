...
#ifdef CONFIG_LV_COORD_TYPE_INT32
...
#  define LV_MEM_CUSTOM_ALLOC   lvgl_port_malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    lvgl_port_free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
...
#ifndef LV_USE_GPU_CSK_DMA2D
    #ifdef CONFIG_LV_USE_GPU_CSK_DMA2D
        #define LV_USE_GPU_CSK_DMA2D CONFIG_LV_USE_GPU_CSK_DMA2D
    #else
        #define LV_USE_GPU_CSK_DMA2D   0
    #endif
#endif
...
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (pdTICKS_TO_MS(xTaskGetTickCount()))     /*Expression evaluating to current system time in ms*/
