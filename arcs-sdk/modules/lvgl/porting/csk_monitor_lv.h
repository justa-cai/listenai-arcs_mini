...
extern volatile uint64_t g_rpc_fill_total_time;
extern volatile uint64_t g_rpc_fill_proxy_time;
extern volatile uint32_t g_rpc_fill_call_cnt;

extern volatile uint64_t g_rpc_map_total_time;
extern volatile uint64_t g_rpc_map_proxy_time;
extern volatile uint32_t g_rpc_map_call_cnt;
#endif
