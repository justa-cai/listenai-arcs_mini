...
/* this is define for esp32 memory manager  */
// #include "esp_heap_caps.h"
// #include "esp_log.h"
// #include "plat_os.h"

static const char *const MEM_TAG = "xml_mem";
...
xmlReallocLoc(void *ptr,size_t size, const char * file, int line)
{
    ...
    //tmp = (MEMHDR *) _esp32_realloc(p,RESERVE_SIZE+size);
    tmp = (MEMHDR *) os_mem_realloc(p,RESERVE_SIZE+size);
    if (!tmp) {
	 //free(p);
     free(p);
	 goto error;
